      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <p className="font-medium text-gray-900">{userProfile?.personalInfo.name}</p>
          </div>
          <div>
            <p className="text-gray-600">Email</p>
            <p className="font-medium text-gray-900">{userProfile?.personalInfo.email}</p>
          </div>
          {userProfile?.personalInfo.spouseName && (
            <div>
              <p className="text-gray-600">Spouse</p>
              <p className="font-medium text-gray-900">{userProfile.personalInfo.spouseName}</p>
            </div>
          )}
